...
d1:	mov [rdi],al
	...
	ret
------------------------------
manu@ubuntu:~/ML$ nasm -felf64 A2.nasm
manu@ubuntu:~/ML$ ld -o A2 A2.o
manu@ubuntu:~/ML$ ./A2
 ##################MENU################## 
 (1) Non-overlapping with string 
 (2) Non-overlapping without string 
 (3) Overlapping with string
 (4) Overlapping without string 
 Enter your choice : 1
 Initial Block : 10 20 30 40 50
 Updated Block : 10 20 30 40 50 10 20 30 40 50
 manu@ubuntu:~/ML$ ./A2
 ##################MENU################## 
 (1) Non-overlapping with string 
 (2) Non-overlapping without string 
 ...
 Enter the number of blocks to be overlaped : 3
 Initial Block : 10 20 30 40 50
 Updated Block : 10 20 10 20 30 40 50 00 00 00
 manu@ubuntu:~/ML$ ./A2
 ##################MENU################## 
 (1) Non-overlapping with string 
 (2) Non-overlapping without string 
 ...
 Enter the number of blocks to be overlaped : 2
 Initial Block : 10 20 30 40 50
 Updated Block : 10 20 30 10 20 30 40 50 00 00
 manu@ubuntu:~/ML$ 
